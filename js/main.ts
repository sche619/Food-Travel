...
var age: any;
var gender: string;
var recommendation: FoodorTravel;
...
function sendFaceRequest(file, callback) : void {
    $.ajax({
        ...
        url: "https://api.projectoxford.ai/face/v1.0/detect?returnFaceAttributes=age,gender",//[?returnFaceId][&returnFaceLandmarks][&returnFaceAttributes]",
...
function findFoodorTravel(age: any, gender: string): FoodorTravel {
    var recommendation;
    if (age < 20) {
...
class FoodorTravel {
    name: string;
    picture: string;
    constructor(public picName, public picUrl) {
        this.name = picName;
        this.picture = picUrl;
    }
}

var chocolate : FoodorTravel = new FoodorTravel("Chocolate","http://demandware.edgesuite.net/sits_pod21/dw/image/v2/AAKG_PRD/on/demandware.static/-/Sites-godiva-master-catalog-us/default/dwde2e684e/large/FALL2013/Product/Truffles24_76143_01.jpg?sw=475&sh=475");
var Paris : FoodorTravel = new FoodorTravel("Paris","http://www.planetware.com/photos-large/F/france-paris-eiffel-tower.jpg");
var Canada : FoodorTravel = new FoodorTravel("Canada","https://www.askideas.com/media/82/Boat-Near-The-Niagara-Falls-In-Canada.jpg");
var salad : FoodorTravel = new FoodorTravel("salad","http://www.taste.com.au/images/recipes/agt/2011/01/chicken-caesar-salad-21436_l.jpeg");
var burger : FoodorTravel = new FoodorTravel("burger","http://www.bajiroo.com/wp-content/uploads/2013/02/biggest-big-burger-epic-food-world-funny-images-pictures-bajiroo-photos-5.jpg");
var Queenstown  : FoodorTravel = new FoodorTravel("Queenstown","https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTRPtmlPdNKgUkHo9BDxI3pH4LN7_zmi9SVLtSXX9Tg5W1O3iQ5");
